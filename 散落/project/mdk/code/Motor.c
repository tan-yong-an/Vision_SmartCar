...
void pid_motor_set(){
	...
	if(game_state == 1)
	{
		motor1.duty=limit(motor1.duty,150);   //152
		motor2.duty=limit(motor2.duty,130);
		motor3.duty=limit(motor3.duty,130);   //132
		motor4.duty=limit(motor4.duty,130);		
	}
	else
	{
		motor1.duty=limit(motor1.duty,150);   //152
		motor2.duty=limit(motor2.duty,130);
		motor3.duty=limit(motor3.duty,130);   //132
		motor4.duty=limit(motor4.duty,13
		0);		
	}
