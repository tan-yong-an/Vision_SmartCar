...
_Pid_param_t pid6 = {.kp=0.06,.ki=0.06, .kd=0.15,.low_pass=1,.out_d=0,.out_i=0,.out_p=0,\
            .p_max=PWM_DUTY_MAX,.i_max=PWM_DUTY_MAX,.d_max=PWM_DUTY_MAX,.pre_error=0,.pre_pre_error=0};//mini_x

_Pid_param_t pid7 = {.kp=0.06,.ki=0.04, .kd=0.15,.low_pass=1,.out_d=0,.out_i=0,.out_p=0,\
